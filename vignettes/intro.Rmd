...
file <- system.file("examples", "chinese.png", package = "cpp11tesseract")
...
```{r}
library(magick)
file <- system.file("examples", "bowers.jpg", package = "cpp11tesseract")
...
```{r}
file <- system.file("examples", "receipt.png", package = "cpp11tesseract")
