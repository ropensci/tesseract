...
![utrecht](https://jeroen.github.io/images/utrecht.png)
...
Note that many of the control parameters have changed between Tesseract 3 and 4, and some no longer work. The major drawback of the new LSTM neural network engine in Tesseract 4 is that the recognition is more accurate but also more difficult to control.
