...
Do note that some of the control parameters have changed between Tesseract 3 and 4.
...
The whitelist parameter works for all versions of Tesseract 3 and also 4.1 and higher, but it was broken for tesseract 4.0 unfortunately.
